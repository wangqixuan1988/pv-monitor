...
int main (int argc, char *argv[])
{
	...
	char sql[1024];
	sprintf (sql, "insert into tb_elec1 values(NULL,now(),%d);",
		//	buf.elec_c,
			buf.elec_v);
	...
	printf("%d\n",shm_buf->rt_status.elec_v);
	
	res = mysql_query(&my_connection, "select * from tb_elec1 where id > 0");//查询数据
