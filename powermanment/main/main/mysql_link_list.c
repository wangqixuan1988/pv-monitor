...
int sqlite_InsertLinknode (float VoltageA_l, float VoltageB_l,float VoltageC_l,float elecpower_l)
{
	...
	slinkTail->next = q;
	slinkTail = q;
	q->VoltageA = VoltageA_l;
	q->VoltageB = VoltageB_l;
	q->VoltageC = VoltageC_l;
